...
const SignUp = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-900 bg-cover bg-no-repeat" style={{ backgroundImage: "url('https://vulcanpost.com/wp-content/uploads/2022/08/nft-1.jpeg')", width: "100vw" }}>
          ...
          >
            <Form>
              ...
              <div className="mt-4 flex justify-center text-lg text-gray-300">
                ...
                <Link to="/collector/login" className="text-teal-500 hover:text-teal-300">
                 LogIn
                </Link>
